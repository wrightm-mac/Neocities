...
function padNumber(num, size) {
  return "000000000000000000000000000000000000000000000000000000".substring(0, size - num.toString().length) + num;
}
...
function getCurrencyArray() {
  ...
  for (let index in currencyList) {
    let currency = currencyList[index];
    currencies[currency.currency] = currency.country;
  }
